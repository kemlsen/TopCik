...
class ClimbResultScreen extends StatelessWidget {
  ...
  String? get _bestBadgeText {
    if (result.isNewBestRound && result.isNewBestScore) {
      return '🏆 Yeni bölüm ve skor rekoru!';
    }
    if (result.isNewBestRound) return '🏆 Yeni bölüm rekoru!';
    if (result.isNewBestScore) return '🏆 Yeni skor rekoru!';
    return null;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bestBadgeText = _bestBadgeText;
